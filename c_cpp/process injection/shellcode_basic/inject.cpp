// Simple process injector just change toEmbed to the shellcode or script you
// want to insert Display of how to use CreateRemoteThread Remember you can only
// build the project in VScode for it to work properly Yes this whole script is
// needed just to showcase one function
/*Function Syntax:
...
unsigned char toEmbed[45056] = {
    // NOTE: Shellocode goes here
};
...
int main(int argc, char *argv[]) {
  ...
  rBuffer = VirtualAllocEx(hProcess, NULL, sizeof(toEmbed),
  ...
  hThread = CreateRemoteThreadEx(
      hProcess, NULL, 0, (LPTHREAD_START_ROUTINE)rBuffer, NULL, 0, 0, &TID);
  if (hThread == NULL) {
